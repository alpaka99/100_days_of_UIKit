...
class MyGenreViewController: UITableViewController {
    var myGenres: [String]!
    ...
    @objc func saveTapped() {
        ...
        let database = CloudStore.store.container.publicCloudDatabase
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let genre = SelectGenreController.genres[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if let cell = tableView.cellForRow(at: indexPath) {
            let selectedGenre = SelectGenreController.genres[indexPath.row]
